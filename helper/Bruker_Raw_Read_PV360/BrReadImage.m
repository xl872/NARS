function [res, p, pathstr] = BrReadImage(path, params)
...
pnames = {'ACQ_size', 'NI', 'NR', 'ACQ_phase_factor', 'ACQ_obj_order', 'SW_h','NSLICES','ACQ_echo_time','ACQ_spatial_phase_1','ACQ_spatial_phase_2','ACQ_ReceiverSelect'};
