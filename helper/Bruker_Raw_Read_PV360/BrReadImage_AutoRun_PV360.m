function [res, p, pathstr] = BrReadImage_AutoRun_PV360(path, params)
...
pnames = {'ACQ_size','ACQ_fov','ACQ_jobs_size','ACQ_jobs', 'NI', 'NR', 'ACQ_phase_factor', 'ACQ_obj_order', ...
          'SW_h','NSLICES','ACQ_echo_time','ACQ_repetition_time','ACQ_spatial_phase_1','ACQ_spatial_phase_2',...
...
for CntFile = 1:NFiles
    ...
    %for PV360, Steve @06032022
    p.ACQ_size(1) = p.ACQ_jobs.value1;
    p.ACQ_size(2) = p.ACQ_jobs.value1;
