...
for da=1:length(dall)
   ...
   'Lower',[0,0,0,0.4,7],...
   'Upper',[Inf,7, Inf,0.4,100],...
   'StartPoint',[tdata(1) 2 tdata(end) 0.4 12]);
...
save T2all_cortexfix2 T2all
legend('off')
fontsize(gcf,20,"points")
print(gcf,['CortexT2_2fixestimate.jpg'],'-djpeg','-r300');
T = struct2table(T2all);
writetable(T, 'T2all_fix2.csv');
...
fontsize(gcf,20,"points")
print(gcf,['CortexT2_2fixestimate_T2.jpg'],'-djpeg','-r300');
...
ylim([0.98 1])
fontsize(gcf,20,"points")
print(gcf,['CortexT2_2fixestimate_r2.jpg'],'-djpeg','-r300');
