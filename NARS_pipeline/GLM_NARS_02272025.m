...
AFNIdata='02272025';
cutoff=3;
MEflag=0; %multi echo 1; one echo:0
...
Exp_Number_all = [76:112,114:123,185:220,222,246:268,270:275];  
...
% %or EPI and other stimulation scheme scans. No data discarded 
...
EN=4;%echo num
for i=1:EN
    Vnn(:,:,:,:,i)=Vn(:,:,:,(i-1)*size(V,4)/EN+1:(i-1)*size(V,4)/EN+27);
end
Vnn=mean(Vnn,5);
